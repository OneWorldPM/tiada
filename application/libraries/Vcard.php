...
class Vcard {
    ...
    function build() {
        ...
        if ($this->data['photo']) {
            $this->card .= "PHOTO;MEDIATYPE=image:" . $this->data['photo'] . "\r\n";
        }
        if ($this->data['email']) {
            $this->card .= "EMAIL;TYPE=internet,pref:" . $this->data['email'] . "\r\n";
        }
        ...
        if ($this->data['address']) {
            $this->card .= "N:" . $this->data['address'] . "\r\n";
        }

        if ($this->data['city']) {
            $this->card .= "N:" . $this->data['city'] . "\r\n";
        }

        if ($this->data['state']) {
            $this->card .= "N:" . $this->data['state'] . "\r\n";
        }

        if ($this->data['country']) {
            $this->card .= "N:" . $this->data['country'] . "\r\n";
        }

        if ($this->data['website']) {
            $this->card .= "URL;TYPE=work:" . $this->data['website'] . "\r\n";
        }

        if ($this->data['twitter']) {
            $this->card .= "url;TYPE=internet:" . $this->data['twitter'] . "\r\n";
        }

        if ($this->data['instagram']) {
            $this->card .= "URL;TYPE=internet:" . $this->data['instagram'] . "\r\n";
        }
        if ($this->data['facebook']) {
            $this->card .= "URL;TYPE=internet:" . $this->data['facebook'] . "\r\n";
        }
        $this->card .= "END:VCARD\r\n";
    }
